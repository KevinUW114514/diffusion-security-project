...
check_point_data = torch.load("clip_text_normalized_embeddings_checkpoint.pt")
prompts = check_point_data["prompts"]
calculated_embeedings = check_point_data["normalized_embeddings"]
embeddings = []
